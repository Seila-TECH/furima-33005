...
RSpec.describe User, type: :model do
  ...
  describe "ユーザー新規登録" do
    it "nicknameとemail、passwordとpassword_confirmation、first_name、last_name、first_na_kana、last_name_kana、birthdayが存在すれば登録できる" do
      expect(@user).to be_valid
    end
    
    it "passwordが6文字以上、且つで半角英数字混合のみであれば登録できる" do
    ...
    it "passwordが半角英数字混合のみでなければ登録できない" do
    ...
    it "last_nameが全角漢字、ひらがな、カタカナでなければ登録できない " do
